...
Travamento após Desafio quando o líder acerta
...
Teste prioritário
Começar partida e chegar à Rodada 2.
Fazer o líder de Influência acertar o Desafio.
Confirmar que aparece para esse país a tela Renovação de carta, mostrando as cartas completas.
Escolher o descarte e verificar que a partida segue para compra/turnos.
Durante a partida, manter o cursor na nota do professor por 20–30 segundos, digitando enquanto outras decisões acontecem; confirmar que o texto não some.
Salvar a nota e confirmar no histórico.
